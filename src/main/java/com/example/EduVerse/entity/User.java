...
import com.example.EduVerse.enums.RankLevel;
...
public class User {
    ...
    @Builder.Default
    private RankLevel rankLevel = RankLevel.BRONZE;

    @Column(name = "contribution_point", nullable = false)
    @Builder.Default
    private Integer contributionPoint = 0;
